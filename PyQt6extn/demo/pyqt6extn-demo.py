#!/usr/bin/python3
#############################################################################################
# CREATOR:  CHARLES K BARCZA  based on ANJAL.P's works                                      #
# ON:       2024 NOV.                                                                       #
# AIM:      To Extend the capability of the PyQt6 Python library with easy to               #
...
# REFER:    Github: https://github.com/blackPantherOS/PyQt6extn                             #
#############################################################################################
...
from PyQt6extn.RoundProgressBar import roundProgressBar
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Demo Application PyQt6extn", None))
